namespace VSRO_CONTROL_API.VSRO.Tools
{
    ...
    {
        // if you ask me how this works i will fucking hit you
        ...
        public static void Encrypt(string path)
        {
            try
            {
                ...
                if (!isEncrypted)
                {
                    ...
                    File.WriteAllBytes($"{Environment.CurrentDirectory}\\textdata\\{Path.GetFileNameWithoutExtension(path)}enc.txt", memoryBuffer);
                }
